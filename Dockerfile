...
FROM python:3.14.6-slim-trixie AS common
...
# Copy the rest of the project (sources, satosa runtime config, tests)
COPY src/ src/
COPY satosa/ satosa/
COPY tests/ tests/
...
# Mouting the uv cache directory to avoid it ending up in the image
